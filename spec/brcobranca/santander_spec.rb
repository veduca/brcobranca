...
describe Brcobranca::Boleto::Santander do
  ...
  it "Gerar boleto" do
    ...
    boleto_novo = Brcobranca::Boleto::Santander.new(@valid_attributes)
    boleto_novo.codigo_barras_segunda_parte.should eql("9189977500009000272070102")
    boleto_novo.codigo_barras.should eql("03399545000000054009189977500009000272070102")
    boleto_novo.codigo_barras.linha_digitavel.should eql("03399.18997 77500.009004 02720.701024 9 54500000005400")
  end
